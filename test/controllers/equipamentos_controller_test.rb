...
class EquipamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipamento" do
    assert_difference("Equipamento.count") do
      post equipamentos_url, params: { equipamento: { condicao: @equipamento.condicao, descricao: @equipamento.descricao, identificador: @equipamento.identificador, status: @equipamento.status, tipo: @equipamento.tipo } }
    end
  ...
  test "should update equipamento" do
    patch equipamento_url(@equipamento), params: { equipamento: { condicao: @equipamento.condicao, descricao: @equipamento.descricao, identificador: @equipamento.identificador, status: @equipamento.status, tipo: @equipamento.tipo } }
