...
class ResponsavelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsavel" do
    assert_difference("Responsavel.count") do
      post responsavels_url, params: { responsavel: { cpf: @responsavel.cpf, email: @responsavel.email, endereco: @responsavel.endereco, matricula: @responsavel.matricula, nome: @responsavel.nome, telefone: @responsavel.telefone, turma: @responsavel.turma } }
    end
  ...
  test "should update responsavel" do
    patch responsavel_url(@responsavel), params: { responsavel: { cpf: @responsavel.cpf, email: @responsavel.email, endereco: @responsavel.endereco, matricula: @responsavel.matricula, nome: @responsavel.nome, telefone: @responsavel.telefone, turma: @responsavel.turma } }
