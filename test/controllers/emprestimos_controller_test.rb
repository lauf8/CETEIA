...
class EmprestimosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emprestimo" do
    assert_difference("Emprestimo.count") do
      post emprestimos_url, params: { emprestimo: { data_devolucao: @emprestimo.data_devolucao, data_emprestimo: @emprestimo.data_emprestimo, responsavel_id: @emprestimo.responsavel_id, status: @emprestimo.status } }
    end
  ...
  test "should update emprestimo" do
    patch emprestimo_url(@emprestimo), params: { emprestimo: { data_devolucao: @emprestimo.data_devolucao, data_emprestimo: @emprestimo.data_emprestimo, responsavel_id: @emprestimo.responsavel_id, status: @emprestimo.status } }
